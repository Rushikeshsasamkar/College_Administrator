...
<div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h3 class="header-line" align=center>Student Registration </h3>
				</div>
				</div></div>
<form action="StudentRes.php" method="post">
<table border="0" align="center">
	<tbody>

		<tr>
			<td><label for="Enrollment_Id">Enrollment_Id: </label></td>
			<td><input id="Enrollment_Id" maxlength="50" name="Enrollment_Id" type="text" /></td>
		</tr>
		...
		<tr>
			<td><label for="Semister">Semister: </label></td>
			<td><input id="Semister" maxlength="50" name="Semister" type="text" /></td>
		</tr>

		<tr>
			<td><label for="Roll_No">Roll_No: </label></td>
			<td><input id="Roll_No" maxlength="50" name="Roll_No" type="text" /></td>
		</tr>
