...
<div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h3 class="header-line" align=center>ADMIN Registration </h3>
...
<form action="AdminRes.php" method="post">
...
<!----- Image ---------------------------------------------------------->
        ...
        <tr>
            ...
            <td><input id="Mobile_No" maxlength="10" name="Mobile_No" type="text" /></td>
        </tr>
